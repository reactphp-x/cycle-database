 ...
 */
final class AsyncDatabaseManager implements DatabaseProviderInterface, LoggerAwareInterface
{
    /** @var AsyncDatabase[] */
     ...
     * @throws DBALException
     */
    public function addDatabase(AsyncDatabase $database): void
    {
     ...
     * @throws DBALException
     */
    private function makeDatabase(DatabasePartial $database): AsyncDatabase
    {
